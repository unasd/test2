...
<%request.setAttribute("test", "테스트");
request.getSession().setAttribute("sessionTest", "세션테스트");%>
<div align="center" class="body">
<h2>카트 확인하기 화면</h2>
<div class="cart">
<table style="font-size: 10pt;">
	<tr>
		<td colspan="2"><font color="green">ㅁㅁ카트에는 다음 상품이 들어있습니다.${test} ${sessionScope.sessionTest}</font></td>
	</tr>
